...
class EventConfidenceUnet(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels=[2, 2, 4, 8, 16, 32, 32], kernel_size=3, blocks=[2, 2, 2, 2, 2, 2, 2],
                 bottleneck_factor=4, squeeze_excitation=False, squeeze_excitation_bottleneck_factor=4,
                 dropout=0.0, use_batch_norm=True, # settings for stem (backbone)
                 ...
                 attn_out_channels=2, attention_bottleneck=None,
