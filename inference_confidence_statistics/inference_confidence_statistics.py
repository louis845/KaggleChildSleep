...
if __name__ == "__main__":
    FOLDER = "inference_confidence_statistics"
    if not os.path.isdir(FOLDER):
        os.mkdir(FOLDER)

    # argparse params
    parser = argparse.ArgumentParser("Inference script for models trained on confidence events data")
    ...
    with open("inference_confidence_stats_options.json", "r") as f:
        options = json.load(f)
